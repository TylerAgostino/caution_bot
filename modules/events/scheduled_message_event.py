...
class ScheduledMessageEvent(TimedEvent):
    ...
    def __init__(self, message: str, race_control: bool = False, broadcast: bool = False, *args, **kwargs):
        """
    ...
    def ui(ident=''):
        ...
        return {
            ...
            'broadcast': col3.checkbox('Send to Broadcast', key=f'{ident}broadcast', value=False),
        }
